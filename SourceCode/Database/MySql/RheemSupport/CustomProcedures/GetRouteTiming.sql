...
drop procedure if exists GetRouteTiming;

delimiter $$
create procedure GetRouteTiming(
...
begin
	SELECT Route,HttpMethod,AVG(DurationMillis) As mSec
	FROM support.apilog
	...
	ORDER BY AVG(DurationMillis) desc
	LIMIT p_numRoutes;
