...
drop procedure if exists GetUserEquipmentAndAttributesWithGas;

delimiter $$
create procedure GetUserEquipmentAndAttributesWithGas(
	IN p_userId int)
begin
...
IF(e.equipmentmasterid = 15, IFNULL((Select objValue From equipmentattribute Where EquipmentId = e.EquipmentId and ObjName='EMAXSETP' Order by equipmentattributeId desc Limit 1), 0), '') As KnobSetting
