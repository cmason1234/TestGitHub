...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[bspGetBOLHeaderInfo_MTMS]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[bspGetBOLHeaderInfo_MTMS]
GO
...
CREATE PROCEDURE [dbo].[bspGetBOLHeaderInfo_MTMS]
