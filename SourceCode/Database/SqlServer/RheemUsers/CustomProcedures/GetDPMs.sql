...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[GetDPMs]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[GetDPMs]
GO
...
BEGIN
	...
	PersonID in (
		...
		where
			o.OrganizationType ='Parts Territory'
	) and 
