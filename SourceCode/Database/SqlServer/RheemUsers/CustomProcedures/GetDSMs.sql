...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[GetDSMs]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[GetDSMs]
GO
...
BEGIN
	...
	PersonID in (
		...
		where
			o.OrganizationType ='Sales Territory'
	) and 
